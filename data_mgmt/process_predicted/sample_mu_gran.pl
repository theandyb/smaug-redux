...
my $parentdir2 = "/net/snowwhite/home/beckandy/research/smaug_granular";
...
my $outfile = "$parentdir2/new_output/predicted/validation_sites.txt";
...
foreach my $chr (1..22){
  ...
  foreach my $categ (@categs){
    my $predfile = "$parentdir2/new_output/predicted/chr$chr.$categ.txt";
